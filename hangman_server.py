...
class ThreadedServer():
    ...
    def gameWaiting(self, serverSocket):
    ...
    def gameRunning(self, serverSocket):
        while self.gameRunning:
            print('entered running game')
            self.runGame(serverSocket)
    ...
    def __init__(self,serverPort, playerCount):
        ...
        self.gameWaiting(serverSocket)
        print(self.addedUsers)
        self.gameRunning(serverSocket)
